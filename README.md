...
and [d640d9d4](https://github.com/unification-com/ledger-unification/commit/d640d9d4)).
...
You can get generated builds from the release tab. THESE ARE UNVETTED DEVELOPMENT/TESTING RELEASES*

Download a release from here (https://github.com/unification-com/ledger-unification/releases). You only need `zxtool.sh`
...
- Install Yarn (for Zemu tests) - https://classic.yarnpkg.com/en/docs/install
